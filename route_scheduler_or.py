...
def main(distance_mat, scheduled_tools, global_dict, num_vehicles):
    ...
    data['demands'] = [1] * 100
    data['vehicle_capacities'] = [global_dict['CAPACITY']]* num_vehicles
    data['num_vehicles'] = num_vehicles
    data['depot'] = global_dict['DEPOT_COORDINATE']
...
#    instance = 'challenge_r100d10_1.txt'
...
#    scheduled_tools, scheduled_requests = schedulers.naive(tools, requests, global_dict['DAYS'])
    main(distance_mat, scheduled_tools, global_dict, 10)